...
| asyncpg | 0.29.0 | Async Postgres driver for the SQLAlchemy async engine at runtime. | `psycopg` async mode | asyncpg is the SQLAlchemy-recommended, fastest async Postgres driver |
